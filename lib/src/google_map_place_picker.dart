...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  _searchByCameraLocation(PlaceProvider provider) async {
    ...
    final GeocodingResponse response = await provider.geocoding
        .searchByLocation(
      Location(lat: provider.cameraPosition!.target.latitude,
  ...
  Widget _defaultPlaceWidgetBuilder(BuildContext context, PickResult? data,
      SearchingState state) {
    return FloatingCard(
  ...
  Widget _buildMapIcons(BuildContext context) {
    final RenderBox appBarRenderBox = appBarKey.currentContext!
        ...
        children: <Widget>[
          enableMapTypeButton!
            ...
            child: RawMaterialButton(
              ...
              fillColor: Theme
                  .of(context)
                  .brightness == Brightness.dark ? Colors.black54 : Colors
                  .white,
              elevation: 8.0,
